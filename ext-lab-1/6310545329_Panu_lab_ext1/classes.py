...
class Card:
    ...
    def power(self, opponent_card):
        ...
        """
        # *** YOUR CODE HERE ***
        return float(self.attack) - (float(opponent_card.defense)/2)
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        # *** YOUR CODE HERE ***
        opponent_attack = opponent_card.attack
        opponent_defense = opponent_card.defense
        opponent_card.attack = opponent_defense
        opponent_card.defense = opponent_attack
...
class ProfessorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        for i in player.deck.cards:
            i.attack += opponent_attack
            i.defense += opponent_defense
        for a in opponent.deck.cards:
            if a.attack != opponent_attack and a.defense != opponent_defense:
                new_deck.append(a)
